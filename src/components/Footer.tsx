...
function Footer() {
  return (
    <div className="min-h-[30vh] w-[100%] flex lg:flex-row flex-col items-center justify-between lg:px-10 py-5 box-border text-white bg-black bottom-0 relative">
      <div className="lg:min-h-[45px] h-[100px] w-[30%] lg:w-[12%] lg:ml-10">
        {" "}
        <img className="h-[100%] w-[100%]" src="/svg/In&O.svg" alt="" />
      </div>{" "}
      <div className="lg:h-[80%] h-[60%] lg:w-[25%]  grid lg:grid-cols-2 lg:gap-2 grid-cols-1 gap-2 lg:ml-0 ml-5">
