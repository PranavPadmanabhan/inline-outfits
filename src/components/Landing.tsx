...
function Landing() {
  ...
  return (
    <div className='h-[80vh] lg:w-full  flex flex-col-reverse lg:flex-row justify-evenly items-center  bg-black pb-5 lg:pb-0'>
        <div className="lg:h-full h-[40%] lg:w-[50%] w-[84%] flex flex-col lg:items-start items-center justify-center lg:pl-48 box-border  ">
            ...
            <button onClick={()=>router.push("/shop")} className='h-[43px] w-[150px] rounded-lg flex justify-center items-center font-medium bg-white lg:mt-5 mt-2  text-black'>Shop Now</button>
        </div>
        <div className="lg:h-full h-[60%] lg:w-[50%] w-[90%] flex items-center justify-center  relative lg:ml-0 lg-mt-none mt-2">
